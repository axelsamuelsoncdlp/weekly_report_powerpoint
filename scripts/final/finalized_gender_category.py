...
INPUT_FILE = os.path.join(BASE_DIR, "data", "raw", "gender_category_raw.csv")
CSV_OUTPUT_FILE = os.path.join(BASE_DIR, "data", "final", "gender_category_final.csv")
...
def load_and_format_data(input_file):
    ...
    df = df[df["Year Type"] == "Current Year"]
...
def save_to_csv(df_pivot, output_file):
    ...
    print(f"\n✅ Successfully saved formatted Gender & Category Revenue data to CSV: {output_file}")


# ✅ Main function to run the entire process
def process_gender_category_data():
